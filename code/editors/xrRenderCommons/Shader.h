...
typedef xr_vector<shared_str>	xrStringVec;
class					CBlenderCompiler;
class					IBlender;
...
//////////////////////////////////////////////////////////////////////////
struct	 XRRENDER_COMMONS_API		ShaderTextureList	: public xr_resource_flagged, public xr_vector<std::pair<u32,ref_texture> >	{
	typedef xr_vector<std::pair<u32,ref_texture> > inherited_vec;
						~ShaderTextureList	();

						IC BOOL		equal (const ShaderTextureList& base) const
						{
...
typedef	resptr_core<ShaderTextureList,resptr_base<ShaderTextureList> >								ref_texture_list;
//////////////////////////////////////////////////////////////////////////
struct	 XRRENDER_COMMONS_API		ShaderMatrixList		: public xr_resource_flagged, public svector<ref_matrix,4>		{
						~ShaderMatrixList	();
};
typedef	resptr_core<ShaderMatrixList,resptr_base<ShaderMatrixList> >									ref_matrix_list;
//////////////////////////////////////////////////////////////////////////
struct	 XRRENDER_COMMONS_API		ShaderConstantList	: public xr_resource_flagged, public svector<ref_constant_obsolette,4>	{
						~ShaderConstantList	();
};
typedef	resptr_core<ShaderConstantList,resptr_base<ShaderConstantList> >								ref_constant_list;

//////////////////////////////////////////////////////////////////////////
struct	 XRRENDER_COMMONS_API		SGeometry		: public xr_resource_flagged									{
	ref_declaration		dcl;
	ID3DVertexBuffer*	vb;
	ID3DIndexBuffer*	ib;
	u32					vb_stride;
...
struct 	XRRENDER_COMMONS_API	resptrcode_geom	: public resptr_base<SGeometry>
{
...
//////////////////////////////////////////////////////////////////////////
struct	  XRRENDER_COMMONS_API		ShaderPass			: public xr_resource_flagged									{
...
#	endif
	...
	BOOL equal(const ShaderPass& other);
};
typedef	resptr_core<ShaderPass,resptr_base<ShaderPass> >												ref_pass;

//////////////////////////////////////////////////////////////////////////
struct 	 XRRENDER_COMMONS_API	ShaderElement	: public xr_resource_flagged									{
public:
	struct ShaderFlags
	{
		u32	iPriority	:	2;
...
//////////////////////////////////////////////////////////////////////////
struct 	 XRRENDER_COMMONS_API	Shader			: public xr_resource_flagged									{
public:
...
struct 	 XRRENDER_COMMONS_API	resptrcode_shader	: public resptr_base<Shader>
{
