...
{
public:
	xrStringVec L_textures;
	xrStringVec L_constants;
	xrStringVec L_matrices;

	LPCSTR detail_texture;
	ConstantTableSetup*	detail_scaler;
...
private:
	...
	ShaderTextureList passTextures;
	ShaderMatrixList passMatrices;
	ShaderConstantList passConstants;
	u32 dwStage;
...
public:
	...
	void r_Constant(LPCSTR name, ConstantTableSetup* s);
#if defined(USE_DX10) || defined(USE_DX11)
...
#	endif
	...
	ShaderElement* _spectre_Compile(LPCSTR namesp, LPCSTR name);
};
//#pragma pack(pop)
