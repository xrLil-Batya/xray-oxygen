...
//--------------------------------------------------------------------------
class XRRENDER_COMMONS_API CCustomMotion
{
protected:
	enum EMotionType
	{
...
//--------------------------------------------------------------------------
class XRRENDER_COMMONS_API COMotion: public CCustomMotion
{
	CEnvelope*		envs			[ctMaxChannel];
public:
					COMotion		();
...
class XRRENDER_COMMONS_API CSMotion: public CCustomMotion{
...
struct XRRENDER_COMMONS_API SAnimParams
{
    float			t_current;
    float			tmp;
    float			min_t;
