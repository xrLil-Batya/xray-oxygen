...
#else
	#define DEV ERenderDevice->Resources
#endif
...
extern dxRenderDeviceRender* g_RDRinstance;
...
{
public:
	static dxRenderDeviceRender& Instance() { if (g_RDRinstance) { return *g_RDRinstance; } else { DebugBreak(); return *g_RDRinstance; } }
	...
	virtual void	OverridePresentSurface();
