...
//
ShaderTextureList::~ShaderTextureList() { DEV->_DeleteTextureList(this); }
ShaderMatrixList::~ShaderMatrixList() { DEV->_DeleteMatrixList(this); }
ShaderConstantList::~ShaderConstantList() { DEV->_DeleteConstantList(this); }
ShaderPass::~ShaderPass() { DEV->_DeletePass(this); }
...
//////////////////////////////////////////////////////////////////////
BOOL ShaderPass::equal(const ShaderPass& other)
{
...
void ShaderTextureList::clear_not_free()
{
	iterator it = begin();
	iterator it_e = end();
...
u32 ShaderTextureList::find_texture_stage(const shared_str &TexName) const
{
	u32	dwTextureStage = 0;

	ShaderTextureList::const_iterator	_it = this->begin();
	ShaderTextureList::const_iterator	_end = this->end();
	for (; _it != _end; ++_it)
	{
