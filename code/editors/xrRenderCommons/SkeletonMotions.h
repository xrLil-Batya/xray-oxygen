...
//*** Motion Data *********************************************************************************
class 	XRRENDER_COMMONS_API	CMotion
{
	struct{
    	u32				_flags	: 8;
		u32				_count 	: 24;
...
class XRRENDER_COMMONS_API motion_marks
{
public:
...
class 	XRRENDER_COMMONS_API	CMotionDef
{
public:
    u16						bone_or_part;
	u16						motion;
...
// partition
class 	XRRENDER_COMMONS_API	CPartDef
{
public:
	shared_str			Name;
	xr_vector<u32>		bones;
...
class 	XRRENDER_COMMONS_API	CPartition
{
...
// shared motions
struct 	XRRENDER_COMMONS_API	motions_value
{
...
class 	XRRENDER_COMMONS_API	motions_container
{
...
public:
 ...
 extern	XRRENDER_COMMONS_API	motions_container*	g_pMotionsContainer;

class 	XRRENDER_COMMONS_API	shared_motions
{
private:
	motions_value*		p_;
protected:
