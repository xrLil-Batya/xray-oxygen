...
property_float_reference::property_float_reference			(float& value, float increment_factor) :
...
void property_float_reference::Increment(float increment)
{
	SetValue						(safe_cast<float>(GetValue()) + increment*m_increment_factor);
}