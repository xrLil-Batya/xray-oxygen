...
{
	GetValue					+= gcnew PropertySpecEventHandler(this, &property_container::GetValue_handler);
	SetValue					+= gcnew PropertySpecEventHandler(this, &property_container::SetValue_handler);
}
...
IProperty^ property_container::value		(PropertySpec^ description)
{
	VERIFY						(m_properties[description]);
...
void property_container::GetValue_handler		(Object^ sender, PropertySpecEventArgs^ e)
{
...
void property_container::SetValue_handler		(Object^ sender, PropertySpecEventArgs^ e)
{
	IProperty				^value = safe_cast<IProperty^>(m_properties[e->Property]);
	VERIFY						(value);
