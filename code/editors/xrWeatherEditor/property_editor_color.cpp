...
void property_editor_color::PaintValue				(PaintValueEventArgs^ arguments)
{
	...
	editor::color			color = safe_cast<property_color_base%>(container->container_holder()).GetValue_raw();
