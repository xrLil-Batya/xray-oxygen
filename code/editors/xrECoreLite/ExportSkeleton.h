...
public:
	...
	inline SkelVertVec& getV_Verts() { return m_Verts; }
	inline SkelFaceVec& getV_Faces() { return m_Faces; }
	inline SSkelVert* getVert() { return &m_Verts[0];/*.begin();*/ }
	inline int getVS() { return m_Verts.size(); }
	//    SSkelFace&		getFace(int id)	{ return VERIFY(id<m_Faces.size()); m_Faces[id];	}
	inline int getTS() { return m_Faces.size(); }
};
//----------------------------------------------------
