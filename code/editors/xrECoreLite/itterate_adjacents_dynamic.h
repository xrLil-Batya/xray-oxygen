#pragma once
#include "../../utils/common/face_smoth_flags.h"
...
public:
	itterate_adjacents_params_dynamic(Fvector &_normal, const u32 *_SmoothGroups, const Fvector *_FaceNormals, const IntVec &_a_lst, const type_face *_Faces, u32 _FaceCount) :
		normal(_normal),
	...
	inline const u32 current_adjacents_size() const
	{
