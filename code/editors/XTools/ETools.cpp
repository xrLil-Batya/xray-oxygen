...
namespace ETOOLS 
{
	...
	ETOOLS_API xr_vector<CDB::RESULT>::iterator	 __stdcall r_begin() { return XRC.r_begin(); };
	ETOOLS_API xr_vector<CDB::RESULT>::iterator	 __stdcall r_end() { return XRC.r_end(); };
