...
extern "C" {
	...
	namespace ETOOLS{
		...
		ETOOLS_API void					__stdcall	collector_add_face_pd(CDB::Collector* CL,const Fvector& v0, const Fvector& v1, const Fvector& v2, size_t dummy, float eps = EPS);
		...
		ETOOLS_API xr_vector<CDB::RESULT>::iterator			__stdcall	r_begin				();
		ETOOLS_API xr_vector<CDB::RESULT>::iterator			__stdcall	r_end				(); 
