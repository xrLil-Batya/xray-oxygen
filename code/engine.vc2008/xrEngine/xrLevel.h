...
class NodePosition {
	...
	ICF	void xz	(u32 value)	{ std::memcpy(data,&value,3);		}
	ICF	void y	(u16 value)	{ std::memcpy(data + 3,&value,2);	}
public:
	ICF	u32	xz	() const	{
	...
	ICF	void link(u8 link_index, u32 value)
	{
		...
		switch (link_index) {
			...
			case 3 : {
                ...
                std::memcpy(data + 7, &value, sizeof(u32));
				break;
			}
		}
	}
...
const u32 MAX_AI_NODES				= (1 << MAX_NODE_BIT_COUNT) - 1;
const u32 MAX_NODE_XZ				= (1 << 24) - 1;
