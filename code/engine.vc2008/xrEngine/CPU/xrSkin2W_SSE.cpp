							...
							CBoneInstance*	Bones) 
{
	...
	// ------------------------------------------------------------------
		edi = D;
		//#NOTE: Двордят лишь для создания переменных (по сути). Поэтому, зачем 
		//нам это всё делать, если мы работаем в C++?
		//Следовательно, в matrix.h уже есть transform_tiny, поэтому делаем аналогию
		//с x86
