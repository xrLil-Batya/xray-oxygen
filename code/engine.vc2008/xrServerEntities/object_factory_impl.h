...
{
	{
		using a = object_type_traits::is_base_and_derived<CLIENT_BASE_CLASS,_client_type>;
        static_assert(a::value, "Client class must be derived from the CLIENT_BASE_CLASS");
	}
	{
		using a = object_type_traits::is_base_and_derived<SERVER_BASE_CLASS,_server_type>;
...
{
	{
		using a = object_type_traits::is_base_and_derived<CLIENT_BASE_CLASS,_unknown_type>;
		using b = object_type_traits::is_base_and_derived<SERVER_BASE_CLASS,_unknown_type>;
