...
#define __ICEPLANE_H__
	...
	class ICEMATHS_API Plane
	{
		...
		inline_	Plane&	Set(float nx, float ny, float nz, float nd)						{ n.Set(nx, ny, nz); d = nd;	    return *this;	}
		inline_	Plane&	Set(const Point& p, const Point& normal)						{ n = normal; d = - p | normal;     return *this;	}
