...
void	CBlender_ss::Compile(CBlender_Compile& C)
{
	...
	{
		case 0:
			C.r_Pass		("SunShaftsTransform", "SunShaftsMask",	FALSE,	FALSE,	FALSE);
			...
			break;
		case 1:
			C.r_Pass		("SunShaftsTransform", "SunShaftsMaskBlur",	FALSE,	FALSE,	FALSE);
			C.r_dx10Texture ("sMask", r2_RT_SunShaftsMask);
			C.r_dx10Sampler("smp_rtlinear");
			C.r_End			();
			break;
		case 2:
			C.r_Pass		("SunShaftsTransform", "SunShaftsGeneration", FALSE, FALSE,	FALSE);
		...
		case 3:
			...
			break;
		case 5:
			C.r_Pass		("SunShaftsTransform", "SunShaftsDisplay",	FALSE,	FALSE,	FALSE);
			C.r_dx10Texture ("sScene", r2_RT_generic0);
