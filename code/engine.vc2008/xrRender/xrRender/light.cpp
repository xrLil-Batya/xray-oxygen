...
void	light::xform_calc			()
{
	...
	// matrix
	Fmatrix mR;
	mR.i	= { L_right.x, L_right.y, L_right.z};
	mR.j	= { L_up.x, L_up.y, L_up.z };
	mR.k	= { L_dir.x, L_dir.y, L_dir.z};
	mR.c	= { position.x, position.y, position.z};
