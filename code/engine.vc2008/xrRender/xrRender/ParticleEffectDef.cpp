...
void CPEDef::ExecuteAnimate(xr_vector<PAPI::Particle>&particles, u32 p_cnt, float dt)
{
...
void CPEDef::ExecuteCollision(xr_vector<PAPI::Particle>& particles, u32 p_cnt, float dt, CParticleEffect* owner, CollisionCallback cb)
{
	pVector pt,n;
