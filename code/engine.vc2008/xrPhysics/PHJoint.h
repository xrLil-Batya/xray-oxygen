...
class CPHJoint : public IPhysicsJoint, public cphysics_scripted
{
	///////////////////////////////////////////////////////
	u16 m_bone_id;
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////
	struct SPHAxis
	{
		...
		inline 	void set_param(const float e, const float c) { erp = e; cfm = c; }
...
public:
	...
	inline CPHElement *PFirstElement() { return pFirst_element; }
	inline CPHElement *PSecondElement() { return pSecond_element; }
