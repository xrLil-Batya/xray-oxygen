...
void Property::construct( shared_str const& property_id, Manager& manager_r )
{
	...
	VERIFY_FORMAT( pSettings->section_exist( m_id ), "Section of upgrade property [%s] does not exist!", m_id.c_str());
	...
	R_ASSERT_FORMAT( ai().script_engine().functor(functor_str, m_desc.functr),
