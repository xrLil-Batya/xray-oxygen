...
// Max collide sound level
float collide_volume_max = 200.f;
// Min collide sound level
float collide_volume_min = 0.f; 
// Some conventional value used as evaluative param (there is no code restriction on mass)
constexpr float mass_limit = 10000.f;

struct EffectPars
{
	constexpr static float vel_cret_sound = 10.f;
	constexpr static float vel_cret_particles = 15.f;
	constexpr static float vel_cret_wallmark = 30.f;
};

struct CharacterEffectPars
{
	constexpr static float vel_cret_sound = 20.f;
	constexpr static float vel_cret_particles = 60.f;
	constexpr static float vel_cret_wallmark = 100.f;
};
