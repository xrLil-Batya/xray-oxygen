...
{
	VERIFY_FORMAT (!m_solving, "do not change preconditions during planner update, object %s, id[%d]",
...
{
	VERIFY_FORMAT(!m_solving,"do not change effects during planner update, object %s, id[%d]",
			object_name(), condition_id);
...
{
	VERIFY_FORMAT (!m_solving, "do not add operators during planner update, object %s, id[%d]",
...
{
	VERIFY_FORMAT(!m_solving, "do not remove operators during planner update, object %s, id[%d]",
		object_name(), operator_id);
...
{
	VERIFY_FORMAT(!m_solving, "do not add evaluators during planner update, object %s, id[%d]",
		object_name(), condition_id);
...
{
	VERIFY_FORMAT(!m_solving, "do not remove evaluators during planner update, object %s, id[%d]",
		object_name(), condition_id);
