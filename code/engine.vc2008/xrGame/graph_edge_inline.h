...
TEMPLATE_SPECIALIZATION
IC	bool CSGraphEdge::operator==	(typename inherited::__vertex_id_type &vertex_id) const
{
...
#define CSGraphEdge CEdge<_edge_weight_type, _vertex_type, imdexlib::empty>
