...
IC	float CALifeSwitchManager::online_distance		() const noexcept
{
	return				(m_online_distance);
}

IC	float CALifeSwitchManager::offline_distance		() const noexcept
{
	return				(m_offline_distance);
}

IC	float CALifeSwitchManager::switch_distance		() const noexcept
{
