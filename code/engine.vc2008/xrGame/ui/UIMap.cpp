...
void	CUICustomMap::SendMessageToWnd			(CUIWindow* pWnd, s16 msg, void* pData)
{
...
void CUILevelMap::SendMessageToWnd(CUIWindow* pWnd, s16 msg, void* pData)
{
...
{
	if (g_extraFeatures.is(GAME_EXTRA_OLD_SCHOOL_MINIMAP))
	{
		CUIStatic cuis;
		////////////////////////////////////////////
