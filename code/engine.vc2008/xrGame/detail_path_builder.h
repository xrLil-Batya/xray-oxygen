...
public:
			...
			void			register_to_process	()
	{
		...
		Device.seqParallel.push_back	(xrDelegate<void()>(this,&CDetailPathBuilder::process));
	}
	...
	IC		void			remove			()
	{
		...
		Device.remove_from_seq_parallel(xrDelegate<void()>(this, &CDetailPathBuilder::process));
	}
};
