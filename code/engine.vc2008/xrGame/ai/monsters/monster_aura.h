...
private:
	...
	bool				m_enabled;
public:
						monster_aura				(CBaseMonster* object, LPCSTR name);
						~monster_aura				();

	void				load_from_ini				(CInifile* ini, LPCSTR section, bool enable_for_dead_default = false);
...
private:
	...
	float				override_if_debug			(LPCSTR var_name, float value) const;
