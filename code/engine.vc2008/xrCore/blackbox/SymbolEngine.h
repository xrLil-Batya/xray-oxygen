...
public:
	...
	BOOL SymGetSymFromAddr(DWORD_PTR dwAddr, OUT PDWORD_PTR pdwDisplacement, OUT PIMAGEHLP_SYMBOL Symbol)
	{
		return (::SymGetSymFromAddr(m_hProcess, dwAddr, pdwDisplacement, Symbol));
	}

	BOOL SymGetSymFromName(LPSTR Name, OUT PIMAGEHLP_SYMBOL Symbol)
	{
...
public:
	...
	BOOL SymRegisterCallback(IN PSYMBOL_REGISTERED_CALLBACK CallbackFunction, IN
#ifdef _M_X64
		ULONG64
#else // !_M_X64
		PVOID
