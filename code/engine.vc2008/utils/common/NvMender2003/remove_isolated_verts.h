...
static void	add_face(const type_face &F, xr_vector<type_vertex> &new_vertices, xr_vector<type_face>  &new_faces, const xr_vector<type_vertex> &vertices, xr_vector<u32> &remap)
{
	type_face new_face;
	for (u32 v = 0; v < 3; v++)
	{
