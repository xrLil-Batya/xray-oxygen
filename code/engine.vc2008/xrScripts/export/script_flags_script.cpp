...
void CScriptFlags::script_register(lua_State *L)
{
	...
	[
		class_<Flags16>		("flags16")
			...
			.def("or",		(Flags16& (Flags16::*)(const Flags16::TYPE))(&Flags16::maskOr))
			.def("or",		(Flags16& (Flags16::*)(const Flags16&,const Flags16::TYPE))(&Flags16::maskOr))
			.def("and",		(Flags16& (Flags16::*)(const Flags16::TYPE))(&Flags16::maskAnd))
			.def("and",		(Flags16& (Flags16::*)(const Flags16&,const Flags16::TYPE))(&Flags16::maskAnd))
			.def("set",		&set<Flags16>)
			.def("is",		&is<Flags16>)
		...
		class_<Flags32>		("flags32")
			...
			.def("or",		(Flags32& (Flags32::*)(const Flags32::TYPE))(&Flags32::maskOr))
			.def("or",		(Flags32& (Flags32::*)(const Flags32&,const Flags32::TYPE))(&Flags32::maskOr))
			.def("and",		(Flags32& (Flags32::*)(const Flags32::TYPE))(&Flags32::maskAnd))
			.def("and",		(Flags32& (Flags32::*)(const Flags32&,const Flags32::TYPE))(&Flags32::maskAnd))
			.def("set",		&set<Flags32>)
			.def("is",		&is<Flags32>)
