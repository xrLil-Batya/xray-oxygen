...
void CScriptFvector::script_register(lua_State* L) {
    module(
        L)[class_<Fvector>("vector")
               ...
               .def("sub", (Fvector & (Fvector::*)(const Fvector&, float))(&Fvector::sub),  return_reference_to<1>()) return_reference_to<1>())
               ...
               .def("average", (Fvector & (Fvector::*)(const Fvector&))(&Fvector::average),
                    return_reference_to<1>())
               .def("average",
                    (Fvector & (Fvector::*)(const Fvector&, const Fvector&))(&Fvector::average),
                    return_reference_to<1>())
               .def("lerp", &Fvector::lerp, return_reference_to<1>())
               .def("mad", (Fvector & (Fvector::*)(const Fvector&, float))(&Fvector::mad),
                    return_reference_to<1>())
               .def("mad",
                    (Fvector & (Fvector::*)(const Fvector&, const Fvector&, float))(&Fvector::mad),
                    return_reference_to<1>())
               .def("mad", (Fvector & (Fvector::*)(const Fvector&, const Fvector&))(&Fvector::mad),
                    return_reference_to<1>())
               .def("mad",
                    (Fvector &
                     (Fvector::*)(const Fvector&, const Fvector&, const Fvector&))(&Fvector::mad),
                    return_reference_to<1>())
               ...
               .def("normalize", (Fvector & (Fvector::*)())(&Fvector::normalize_safe),
                    return_reference_to<1>())
               ...
               .def("normalize_safe", (Fvector & (Fvector::*)())(&Fvector::normalize_safe),
                    return_reference_to<1>())
               .def("normalize_safe",
                    (Fvector & (Fvector::*)(const Fvector&))(&Fvector::normalize_safe),
                    return_reference_to<1>())
               //			.def("random_dir",					(Fvector
               //& (Fvector::*)())(&Fvector::random_dir),
               //return_reference_to<1>()) 			.def("random_dir",
               //(Fvector & (Fvector::*)(const Fvector &, float))(&Fvector::random_dir),
               //return_reference_to<1>()) 			.def("random_point",
               //(Fvector & (Fvector::*)(const Fvector &))(&Fvector::random_point),
               //return_reference_to<1>()) 			.def("random_point",
               ...
               //			.def("from_bary",					(Fvector &
               //(Fvector::*)(const Fvector &, const Fvector &, const Fvector &, float, float,
               //float))(&Fvector::from_bary),	return_reference_to(_1))
               //			.def("from_bary",					(Fvector &
               //(Fvector::*)(const Fvector &, const Fvector &, const Fvector &, const Fvector
               //&))(&Fvector::from_bary),		return_reference_to(_1))
               //			.def("from_bary4",
               //&Fvector::from_bary4,
               //return_reference_to(_1)) 			.def("mknormal_non_normalized",
               //&Fvector::mknormal_non_normalized,
               //return_reference_to(_1)) 			.def("mknormal",
               //&Fvector::mknormal,
           ...
           class_<Fvector2>("vector2")
               ...
               .def(constructor<>())
               .def("set", (Fvector2 & (Fvector2::*)(float, float))(&Fvector2::set),
                    return_reference_to<1>())
