...
public:
	...
	static bool 	InitCustomEdit			(CXml& xml_doc, LPCSTR paht, int index, CUICustomEdit* pWnd);
	static bool 	InitEditBox				(CXml& xml_doc, LPCSTR paht, int index, CUIEditBox* pWnd);
	...
	static bool 	InitOptionsItem			(CXml& xml_doc, LPCSTR paht, int index, CUIOptionsItem* pWnd);
