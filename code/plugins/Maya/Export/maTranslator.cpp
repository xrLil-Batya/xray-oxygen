...
//
{
    ...
    if (objectCount > 0)
    {
        ...
        if (transformNodeNameArray.length() > 0)
        {
            ...
            for (i = 0; i < objectCount; i++)
            {
                ...
                {
					Msg("!calloc returned NULL (objectGroupsTablePtr)");
                    return false;
                }
            }
        }
    ...
    if (objectCount > 0)
    {
        ...
        for (i = 0; i < objectCount; i++)
        {
            ...
            {
				Msg("!calloc returned NULL (vertexTable)");
                return false;
            }
            ...
            {
				Msg("!calloc returned NULL (polygonTable)");
                return false;
            }
        }
    }
