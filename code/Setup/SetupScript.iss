...
russian.STR_OXY_CONFIG=Êîíôèãóðàöèÿ
english.STR_OXY_PRESET=Preset
russian.STR_OXY_PRESET=Øàáëîí
english.STR_OXY_VANILLA=Vanilla
russian.STR_OXY_VANILLA=Îðèãèíàëüíûå
english.STR_OXY_EVERYTHING=Everything
russian.STR_OXY_EVERYTHING=Âñ¸
english.STR_OXY_MSVS_REDIST=Install Microsoft Visual Studio redistributables (recommended)
russian.STR_OXY_MSVS_REDIST=Óñòàíîâèòü Microsoft Visual Studio redistributables (ðåêîìåíäóåòñÿ)
english.STR_OXY_OAL=Install OpenAL Soft
russian.STR_OXY_OAL=Óñòàíîâèòü OpenAL Soft
english.STR_OXY_FEATURE_MONSTER_INV=Monster Inventory
russian.STR_OXY_FEATURE_MONSTER_INV=Èíâåíòàðü ó ìîíñòðîâ
english.STR_OXY_FEATURE_ANTIFREEZE=Delayed npc spawn (increase performance)
russian.STR_OXY_FEATURE_ANTIFREEZE=Îòëîæåííûé ðåñïàâí ÍÏÑ (ïîâûøàåò ïðîèçâîäèòåëüíîñòü)
english.STR_OXY_FEATURE_POLTERHEIST=Polterheist Death Particles
russian.STR_OXY_FEATURE_POLTERHEIST=Ýôôåêò ñìåðòè ó Ïîëòåðãåéñòà
english.STR_OXY_FEATURE_THIRST=Thirst
russian.STR_OXY_FEATURE_THIRST=Æàæäà
english.STR_OXY_FEATURE_PICKUP=Always show pickup item text
russian.STR_OXY_FEATURE_PICKUP=Âñåãäà ïîêàçûâàòü ïîäñêàçêè ïî ïðåäìåòàì âîêðóã
