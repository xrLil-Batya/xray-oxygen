...
#define __OPC_RAYCOLLIDER_H__
	...
	class OPCODE_API CollisionFace
	{
		...
		inline_				~CollisionFace()		{}
				...
				uqword		mFaceID;				//!< Index of touched face
	...
	class OPCODE_API CollisionFaces : private Container
	{
		...
		inline_	uqword					GetNbFaces()					const	{ return GetNbEntries()>>2;						}
	...
	class OPCODE_API RayCollider : public Collider
	{
		 ...
		 */
		///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
							bool			Collide(const Ray& world_ray, const Model& model, const Matrix4x4* world=null, uqword* cache=null);
		//
		 ...
		 */
		///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		inline_				uqword			GetNbRayBVTests()				const	{ return mNbRayBVTests;		}
		 ...
		 */
		///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		inline_				uqword			GetNbRayPrimTests()				const	{ return mNbRayPrimTests;	}
		 ...
		 */
		///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		inline_				uqword			GetNbIntersections()			const	{ return mNbIntersections;	}
...
#endif
		// Stats
							uqword			mNbRayBVTests;		//!< Number of Ray-BV tests
							uqword			mNbRayPrimTests;	//!< Number of Ray-Primitive tests
		// In-out test
							uqword			mNbIntersections;	//!< Number of valid intersections
		...
		inline_				BOOL			RayTriOverlap(const Point& vert0, const Point& vert1, const Point& vert2);
			// Init methods
							BOOL			InitQuery(const Ray& world_ray, const Matrix4x4* world=null, uqword* face_id=null);
	};
