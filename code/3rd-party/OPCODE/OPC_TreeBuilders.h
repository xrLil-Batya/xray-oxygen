...
#define __OPC_TREEBUILDERS_H__
	...
	struct OPCODE_API BuildSettings
	{
		...
		uqword	mLimit;		//!< Limit number of primitives / node. If limit is 1, build a complete tree (2*N-1 nodes)
		uqword	mRules;		//!< Building/Splitting rules (a combination of SplittingRules flags)
	};
	...
	class OPCODE_API AABBTreeBuilder
	{
		 ...
		 */
		///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		virtual						bool			ComputeGlobalBox(const uqword* primitives, uqword nb_prims, AABB& global_box)	const	= 0;
		 ...
		 */
		///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		virtual						float			GetSplittingValue(uqword index, uqword axis)	const	= 0;
		 ...
		 */
		///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		virtual						float			GetSplittingValue(const uqword* primitives, uqword nb_prims, const AABB& global_box, uqword axis)	const
													{
		 ...
		 */
		///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		virtual						BOOL			ValidateSubdivision(const uqword* primitives, uqword nb_prims, const AABB& global_box)
													{
									...
									uqword			mNbPrimitives;		//!< Total number of primitives.
									void*			mNodeBase;			//!< Address of node pool [Opcode 1.3]
		// Stats
		inline_						void			SetCount(uqword nb)				{ mCount=nb;				}
		inline_						void			IncreaseCount(uqword nb)		{ mCount+=nb;				}
		inline_						uqword			GetCount()				const	{ return mCount;			}
		inline_						void			SetNbInvalidSplits(uqword nb)	{ mNbInvalidSplits=nb;		}
		inline_						void			IncreaseNbInvalidSplits()		{ mNbInvalidSplits++;		}
		inline_						uqword			GetNbInvalidSplits()	const	{ return mNbInvalidSplits;	}

		private:
									uqword			mCount;				//!< Stats: number of nodes created
									uqword			mNbInvalidSplits;	//!< Stats: number of invalid splits
	};
