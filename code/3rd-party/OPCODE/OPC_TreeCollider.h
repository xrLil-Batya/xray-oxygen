...
#define __OPC_TREECOLLIDER_H__
	...
	class OPCODE_API AABBTreeCollider : public Collider
	{
		 ...
		 */
		///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		inline_				uqword			GetNbBVBVTests()				const	{ return mNbBVBVTests;							}
		 ...
		 */
		///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		inline_				uqword			GetNbPrimPrimTests()			const	{ return mNbPrimPrimTests;						}
		 ...
		 */
		///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		inline_				uqword			GetNbBVPrimTests()				const	{ return mNbBVPrimTests;						}
		 ...
		 */
		///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		inline_				uqword			GetNbPairs()					const	{ return mPairs.GetNbEntries()>>1;				}
		...
		// Stats
							uqword			mNbBVBVTests;		//!< Number of BV-BV tests
							uqword			mNbPrimPrimTests;	//!< Number of Primitive-Primitive tests
							uqword			mNbBVPrimTests;		//!< Number of BV-Primitive tests
		// Precomputed data
		...
		// Leaf description
							...
							uqword			mLeafIndex;			//!< Triangle index
		// Settings
		...
		// Internal methods
			...
			// Overlap tests
							void			PrimTest(uqword id0, uqword id1);
			inline_			void			PrimTestTriIndex(uqword id1);
			inline_			void			PrimTestIndexTri(uqword id0);
