...
typedef struct st_EDPolygonInfo
{
    ...
    const char      *surface /* language encoded */;
    unsigned int     type;
    int              typeFlags;
...
typedef struct st_MeshEditOp
{
    ...
    LWPolID             (*addFace)          (EDStateRef, const char *surf /* language encoded */, int numPnt, const LWPntID *);
    LWPolID             (*addCurve)         (EDStateRef, const char *surf /* language encoded */, int numPnt, const LWPntID *, int flags);
    ...
    EDError             (*polSurf)          (EDStateRef, LWPolID, const char *surf /* language encoded */);
    EDError             (*polPnts)          (EDStateRef, LWPolID, int, const LWPntID *);
    EDError             (*polFlag)          (EDStateRef, LWPolID, int mask, int value);

    EDError             (*polTag)           (EDStateRef, LWPolID, LWID, const char *tag /* language encoded */);
    EDError             (*pntVMap)          (EDStateRef, LWPntID, LWID, const char *vmap_name /* language encoded */, int, float *);

    LWPolID             (*addPoly)          (EDStateRef, LWID type, LWPolID, const char *surf /* language encoded */, int numPnt, const LWPntID *);
    LWPntID             (*addIPnt)          (EDStateRef, double *xyz, int numPnt, const LWPntID *, const double *wt);
    EDError             (*initUV)           (EDStateRef, float *uv);

    void *              (*pointVSet)        (EDStateRef, void *vmap_id, LWID vmap_type, const char *vmap_name /* language encoded */);
    int                 (*pointVGet)        (EDStateRef, LWPntID point_id, float *vmap_vector);
    const char * /* language encoded */ (*polyTag)          (EDStateRef, LWPolID polygon_id, LWID tag_type);
    ...
    EDError             (*pntVPMap)         (EDStateRef, LWPntID point_id, LWPolID polygon_id, LWID vmap_type, const char *vmap_name /* language encoded */, int vmap_dimensions, float *vmap_vector);
    ...
    /// @{
        void *               (*vMapSelect)      (EDStateRef es, const char *vmap_name /* language encoded */, LWID type, int dim);
        int                  (*vMapExists)      (EDStateRef es, const char *vmap_name /* language encoded */, LWID type);
        ...
        void                 (*vMapRename)      (EDStateRef es, const char *new_name /* language encoded */);
    ...
    /// @{
        ...
        const char * /* language encoded */ (*polySurface)(EDStateRef es, LWPolID p);
    /// @}
