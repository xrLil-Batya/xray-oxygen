...
typedef struct st_LWLMonFuncs {
  ...
  void       (*setup)     ( LWLMonID mon, char *title /* language encoded */, unsigned int uiflags, const char *histfile /* language encoded */ );
  void       (*setwinpos) ( LWLMonID mon, int x, int y, int w, int h );
  void       (*init)      ( LWLMonID mon, unsigned int total, const char *msg /* language encoded */ );
  int        (*step)      ( LWLMonID mon, unsigned int incr, const char *msg /* language encoded */ );
