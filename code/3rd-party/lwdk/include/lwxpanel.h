...
typedef struct st_LWXPDrawFuncs {
        ...
        int    (*textWidth)    ( LWXPDrAreaID p, char *s /* language encoded */ );
        int    (*textHeight)   ( LWXPDrAreaID p, char *s /* language encoded */ );
        void   (*drawText)     ( LWXPDrAreaID p, char *s /* language encoded */, int c, int x, int y );
} LWXPDrawFuncs;
