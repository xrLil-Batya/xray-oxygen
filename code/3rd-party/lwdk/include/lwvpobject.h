...
#define LWVIEWPORTOBJECT_VERSION 4
...
typedef struct st_LWViewportObjectAccess {
    int          (*showFrame   )( struct st_LWVPAHostAccess *, unsigned int, unsigned int, float *, unsigned int, float *, unsigned int, unsigned int, unsigned int );
...
typedef struct st_LWViewportHandler {
    ...
    const char * /* language encoded */ (*menuName    )( LWInstance, unsigned int );                       /*!< Name  of menu entry.                      */
