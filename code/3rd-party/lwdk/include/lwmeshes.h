...
typedef struct st_LWMeshInfo
{
    ...
    void *          (*pntVLookup)   (LWMeshInfoID, LWID polygon_type, const char *vmap_name /* language encoded */);
    ...
    const char * /* language encoded */ (*polTag)       (LWMeshInfoID, LWPolID, LWID);
     ...
     */
    void *          (*pntVIDLookup)   (LWMeshInfoID, LWID polygon_type, const char *vmap_name /* language encoded */);
...
{
    int             (*numObjects)  (void);
    const char * /* language encoded */ (*filename)    (int obj);
    ...
    int             (*numVMaps)    (LWID);
    const char * /* language encoded */ (*vmapName)    (LWID, int in_index);
    int             (*vmapDim)     (LWID, int in_index);
    LWID            (*vmapType)    (int in_index);

    const char * /* language encoded */ (*layerName)   (int obj, int lnum);
    int             (*layerVis)    (int obj, int lnum);

    const char * /* language encoded */ (*userName)    (int obj);
    const char * /* language encoded */ (*refName)     (int obj);
