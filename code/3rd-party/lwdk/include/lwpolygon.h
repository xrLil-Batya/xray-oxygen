...
{
    void *priv;
    void *       (*pntVLookup)  (LWPolygonTypeAccessID, LWID, const char *vmap_name /* language encoded */);
    ...
    const char * /* language encoded */ (*polTag)      (LWPolygonTypeAccessID, LWPolID, LWID);
...
typedef struct st_LWPtypeWireDrawAccess
{
    ...
    void        (*text)   (void *data, const char *text /* language encoded */, int);
