...
typedef struct  st_LWTxtrParamDesc{
    char            *name /* ascii encoded? */;     // parameter name for gradient input POPUP
    ...
    char            *itemName /* language encoded */;   // item name if any
} LWTxtrParamDesc;
...
#define LWTEXTUREFUNCS_GLOBAL   "Texture Functions 4"
