...
typedef char **LWShelfParmList; /* 0-terminated array of 0-terminated character strings */ /* ASCII encoding */

typedef int  LWShelfLoadOkFunc ( void *userdata );
typedef void LWShelfLoadFunc   ( void *userdata, const LWLoadState *load,
                                 const char *filename /* language encoded */, LWShelfParmList parms );
...
typedef struct st_LWShelfFuncs {
  ...
  LWShelfCltID (*subscribe)      ( char *name /* language encoded */, char *subName /* language encoded */,
  ...
  void         (*load)           ( LWShelfCltID clt, char *filename /* language encoded */, int prompt_user );
  void         (*save)           ( LWShelfCltID clt, char *filename /* language encoded */, LWImageID thumimg, LWShelfParmList parms );
  int          (*addNamedPreset) ( LWShelfCltID clt, LWImageID img, LWShelfParmList parms, const char *name /* language encoded */, const char *comment /* language encoded */ );
} LWShelfFuncs;
