...
typedef struct st_LWObjectImport {
    ...
    LWMonitor   *monitor;
    char        *failedBuf /* language encoded */;
    int         failedLen;
    void        *data;

    void        (*done)    (void *);
    void        (*layer)   (void *, int lNum, const char *name /* language encoded */);
    ...
    void        (*vmap)    (void *, LWID type, int dim, const char *name /* language encoded */);
    void        (*vmapVal) (void *, LWPntID point, const float *val);
    LWPolID     (*polygon) (void *, LWID type, int flags, int numPts, const LWPntID *);
    void        (*polTag)  (void *, LWPolID polygon, LWID type, const char *tag /* language encoded */);
    void        (*surface) (void *, const char *basename /* language encoded */, const char *refname /* language encoded */, int chunk_size, void *surf_chunk);
    ...
    void*       (*curVmap) (void *);
    LWImageID   (*loadBitmap) (const char *path /* language encoded  */);
