...
typedef struct LWColorSpaceFuncs_t {
    ...
    LWCOLORSPACE            (*nameToColorSpace       )( char *name /* utf8 encoded */ );   /*!< Color space name. */
    LWCOLORSPACE            (*loadPixelLookupTable   )( char *file /* utf8 encoded */ );   /*!< File name.        */
    ...
    const char             * /* utf8 encoded */(*colorSpaceName         )( LWCOLORSPACETYPES );    /*!< Gets the name of the current color space of the type selected. */
    const char             * /* utf8 encoded */(*colorSpaceFile         )( LWCOLORSPACETYPES );    /*!< Gets the file of the current color space of the type selected. */
    ...
    const char             * /* utf8 encoded */(*nameOfColorSpaces      )( LWCOLORSPACELAYER, int);/*!< Gets the name of the color space in the layer.                 */
    ...
    LWCOLORSPACE            (*getColorSpace          )( const char * /* utf8 encoded */);         /*!< Returns the color space setting of the color space type */
    int                     (*getColorSpaceBoolean   )( const char * /* utf8 encoded */);         /*!< Returns the state of a color space check box.           */
    int                     (*setColorSpaceBoolean   )( const char * /* utf8 encoded */, int );    /*!< Sets the state of a color space check box.              */
} LWColorSpaceFuncs;
