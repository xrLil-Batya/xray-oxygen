...
MFloatPoint operator*( int, const MFloatPoint&);
MFloatPoint operator*( short, const MFloatPoint&);
MFloatPoint operator*( unsigned int, const MFloatPoint&);
MFloatPoint operator*( unsigned short, const MFloatPoint&);
MFloatPoint operator*( float, const MFloatPoint&);
MFloatPoint operator*( double, const MFloatPoint&);
#endif
