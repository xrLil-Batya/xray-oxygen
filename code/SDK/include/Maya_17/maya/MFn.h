...
public:
    ...
    // RJ
		...
		kAnimLayerClip = kTimeEditorClipBase,			//!< Used for backward compatibility
		kAnimLayerClipTRS = kTimeEditorClipEvaluator,	//!< Used for backward compatibility
		kAnimLayerClipContainer = kTimeEditorClip		//!< Used for backward compatibility
	};
