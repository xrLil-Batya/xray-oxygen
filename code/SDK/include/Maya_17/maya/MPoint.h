...
MPoint operator*( int, const MPoint&);
MPoint operator*( short, const MPoint&);
MPoint operator*( unsigned int, const MPoint&);
MPoint operator*( unsigned short, const MPoint&);
MPoint operator*( float, const MPoint&);
MPoint operator*( double, const MPoint&);
#endif
