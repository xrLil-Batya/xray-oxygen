...
//                #endif
	...
	//float  att 	= 1.0f/rsqr;
	//float  att 	= 1.0f/rsqr-Ldynamic_pos.w;
	//float  att 	= 5*(sqrt(1.0f/rsqr)-sqrt(Ldynamic_pos.w));
	...
	// out
	//float maxIntens = 1.0f/100.0f;
	//float maxIntens = 1.0f/40.0f;	
	//float maxIntens = 1.0f/10.0f;
